...
extension MainViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "sampleViewCell", for: indexPath)
            cell.textLabel?.text = "UIViewライフサイクル"
            return cell
        }
    }
}
...
extension MainViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        default:
            ...
            let viewController = storyBoard.instantiateViewController(withIdentifier: "SampleViewController")
            navigationController?.pushViewController(viewController, animated: true)
        }
    }
}
